...
public class ArticleDao {
  ...
  public int register(ArticleDto dto) {
    ...
    try {
      ...
      // 쿼리문 작성 
      String sql = "INSERT INTO ARTICLE_T(ARTILCE_NO, TITLE, CONTENT, EDITOR, HIT, LASTMODIFIED, CREATED) VALUES (ARTICLE_SEQ.NEXTVAL, ?, ?, ?, ?,SYSDATE,SYSDATE)";
